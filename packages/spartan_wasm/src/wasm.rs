...
mod test {
    ...
    fn check_nizk_rsa() {
        let root = current_dir().unwrap();
        let circuit = fs::read(root.join("rsa/rsa.circuit")).unwrap();
        let vars = fs::read(root.join("rsa/witness.wtns")).unwrap();

        let public_inputs = [
            "12094727817759497213",
            "5591764949547567316",
            "514003651015732064",
            "5679964585692357569",
            "10191956608124027050",
            "13078784538174391955",
            "16488997767129875534",
            "16104412100242280264",
            "3029348867544290990",
            "15198849857344867520",
            "17262963679034847389",
            "13892463527227915342",
            "17492113632606892147",
            "5285563744550770351",
            "8179687963547178417",
            "13889983745086855376",
            "0",
            "0",
            "0",
            "0",
